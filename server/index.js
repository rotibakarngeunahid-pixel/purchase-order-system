...
const outletMaterialSuppliersRouter = require('./routes/outletMaterialSuppliers');
...
app.use('/api/outlet-material-suppliers', authMiddleware, outletMaterialSuppliersRouter);
