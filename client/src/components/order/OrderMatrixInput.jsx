          ...
          <tbody>
            {materials.map((mat) => {
              ...
              return (
                ...
                >
                  <td
                    className="sticky left-0 z-10 px-3 py-2 border-r border-gray-200 font-medium text-gray-800"
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="leading-tight mt-0.5 text-sm">{mat.name}</div>
                        <div className="text-xs text-brand-orange leading-none mt-0.5">{mat.purchase_unit}</div>
                        {isRoti && (
